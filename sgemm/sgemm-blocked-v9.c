...
#define K16x16_AVX512_INTRINSICS_PACKING \
a = _mm512_load_ps(&A[lda * k    ]);\
b1 = _mm512_set1_ps(B[k + 0 + ldb * 0]);\
b2 = _mm512_set1_ps(B[k + 0 + ldb * 1]);\
b3 = _mm512_set1_ps(B[k + 0 + ldb * 2]);\
b4 = _mm512_set1_ps(B[k + 0 + ldb * 3]);\
b5 = _mm512_set1_ps(B[k + 0 + ldb * 4]);\
b6 = _mm512_set1_ps(B[k + 0 + ldb * 5]);\
b7 = _mm512_set1_ps(B[k + 0 + ldb * 6]);\
b8 = _mm512_set1_ps(B[k + 0 + ldb * 7]);\
b9 = _mm512_set1_ps(B[k + 0 + ldb * 8]);\
b10 = _mm512_set1_ps(B[k + 0 + ldb * 9]);\
b11 = _mm512_set1_ps(B[k + 0 + ldb * 10]);\
b12 = _mm512_set1_ps(B[k + 0 + ldb * 11]);\
b13 = _mm512_set1_ps(B[k + 0 + ldb * 12]);\
b14 = _mm512_set1_ps(B[k + 0 + ldb * 13]);\
b15 = _mm512_set1_ps(B[k + 0 + ldb * 14]);\
b16 = _mm512_set1_ps(B[k + 0 + ldb * 15]);\
...
k++;
#define K32x8_AVX512_INTRINSICS_PACKING \
